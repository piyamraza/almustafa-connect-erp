...
$anchors = @{
    'lib/features/exams/domain/entities/exam_entity.dart' = 'class ExamEntity extends Equatable'
    'lib/features/exams/data/models/exam_model.dart' = 'class ExamModel extends ExamEntity'
    'lib/features/exams/presentation/pages/exam_form_page.dart' = 'class ExamFormPage extends StatefulWidget'
    'lib/features/exams/presentation/pages/exams_page.dart' = 'class ExamsPage extends StatelessWidget'
}
