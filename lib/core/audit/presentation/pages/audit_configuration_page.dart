...
import '../../../../features/access_control/domain/entities/app_permission.dart';
    ...
    return Scaffold(
      ...
      body: BlocConsumer<AuditConfigurationBloc, AuditConfigurationState>(
        ...
        builder: (context, state) {
          ...
          final canViewLogs = sl<AccessControlService>().hasPermission(
            AppPermission.auditLogsView,
          );
              ...
              if (canViewLogs) ...[
                Card(
                  child: ListTile(
                    ...
                    subtitle: const Text(
                      'View and filter recorded system activity.',
                    ),
