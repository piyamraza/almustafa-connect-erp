...
class BonafideCertificatePreviewPage extends StatefulWidget {
  const BonafideCertificatePreviewPage({
    super.key,
  ...
  @override
  State<BonafideCertificatePreviewPage> createState() =>
      _BonafideCertificatePreviewPageState();
}

class _BonafideCertificatePreviewPageState
