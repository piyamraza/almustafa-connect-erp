...
class _StaffSalaryViewState
  ...
  Future<void> _exportPayrollExcel() async {
    final currentState =
        context.read<StaffSalaryBloc>().state;

    if (currentState is! StaffSalaryLoaded ||
        currentState.salaries.isEmpty) {
      ScaffoldMessenger.of(context)
        ..hideCurrentSnackBar()
        ..showSnackBar(
          const SnackBar(
            content: Text(
              'Generate salaries before exporting Excel.',
            ),
    ...
    try {
      await StaffPayrollExcelService
      ...
      messenger
        ...
        ..showSnackBar(
          const SnackBar(
            content: Text(
              'Payroll Excel export completed.',
            ),
            behavior: SnackBarBehavior.floating,
          ),
        );
  ...
  void _openPayrollReport() {
    Navigator.of(context).push<void>(
      MaterialPageRoute<void>(
        builder: (_) => StaffPayrollReportPage(
          salaryMonth: _selectedMonth,
        ),
      ),
    );
        ...
        appBar: AppBar(
          ...
          actions: [const DashboardNavigationButton(),
            IconButton(
              ...
              tooltip: 'Monthly Payroll Report',
              onPressed: _openPayrollReport,
              icon: const Icon(
