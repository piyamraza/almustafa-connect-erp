    ...
    return Scaffold(
      ...
      body: BlocBuilder<ResultDetailsBloc, ResultDetailsState>(
        builder: (context, state) {
          return switch (state) {
            ResultDetailsInitial() => const Center(
            ...
            ResultDetailsLoaded(:final result, :final student) =>
              _DetailsContent(result: result, student: student),
            ResultDetailsFailure(:final result, :final message) =>
              _DetailsContent(result: result, studentLoadError: message),
          };
        },
      ),
    );
            ...
            child: Column(
              ...
              children: [
                ...
                if (studentLoadError != null) ...[
                  _ReadOnlyNotice(
                    message:
                        'Student profile details are unavailable: $studentLoadError',
                  ),
      ...
      children: [
        ...
        Wrap(
          ...
          children: [
            _KeyValue(
              label: 'Admission No',
              value: _display(result.admissionNo),
            ),
            _KeyValue(label: 'Roll No', value: _display(result.rollNumber)),
            _KeyValue(
              label: 'Father Name',
              value: _display(student?.fatherName ?? ''),
            ),
            ...
            Wrap(
              ...
              children: [
                ...
                _KeyValue(
                  ...
                  value: _display(result.academicSession),
                ),
                _KeyValue(
                  label: 'Total Marks',
        ...
        child: Column(
          ...
          children: [
            ...
            _RemarkRow(
              ...
              value: _display(teacherRemarks),
            ),
            const SizedBox(height: 12),
            _RemarkRow(
              label: 'Principal Remarks',
              value: _display(result.principalRemarks),
            ),
            const SizedBox(height: 12),
            const _ReadOnlyNotice(
              message: 'This published result is read-only.',
            ),
          ],
        ),
      ),
